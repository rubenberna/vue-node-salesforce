...
router.post('/', async (req, res) => {
  ...
  const q = `SELECT Id, Name, Email, RegioId__c, MailingAddress, External_Id__c, Signed_Contract__c, Signed_Contract_Date__c FROM Contact WHERE External_Id__c = '${dplanId}'`;
